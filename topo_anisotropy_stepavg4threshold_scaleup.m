...
window=0;
for ii=1:2:15
    radius=4000*ii; radwindow=4000; radstep=4000; % measure correlation to radius advancing by radstep
...
%     cc=24;
    ...
    aspect_ratio=1-sqrt(semiminor^2/semimajor^2);
    tilt=rad2deg(angle(ind));
    ...
    [elat,elon]=ellipse1(yy_deg,xx_deg,[rad_deg aspect_ratio],90-tilt);
