...
for i=1:length(xc);
    ...
    for a=1:tic-1
        ...
        if C(a,i)==c2
            if g==1
                b=ft(g,1)/3; d=ft(g,1)-thickness(a,i);
                if d>2*b
                ...
                if d>=b
                    thickness2(g+1,i)= b;
                    C2(g+1,i)=c2;
                    thickness2(g,i)= thickness(a,i)-b;
                    C2(g,i)=c3;
                    continue
                end
                if d<b
                    ...
                    thickness2(g+1,i)= b;
                    C2(g+1,i)=c3;
                    thickness2(g,i)= thickness(a,i)-2*b;
                    C2(g,i)=c2;
                    continue
                end
            else
