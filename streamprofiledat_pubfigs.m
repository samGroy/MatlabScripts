function c=streamprofiledat_pubfigs(basenm,ts,wavelength1,wavelength2,x,y)
...
[id,idticker,steparc, nodedat, netdat]=tortuosityprofile4(basenm,ts,wavelength1,x,y);
[id2,idticker2,steparc2, nodedat2, netdat2]=tortuosityprofile4(basenm,ts,wavelength2,x,y);
...
j=scatter3(idticker(:,1),idticker(:,2),10+zorf(1:length(idticker)),'filled', 'MarkerEdgeColor','k','MarkerFaceColor','w');
