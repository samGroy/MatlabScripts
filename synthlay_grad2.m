...
for i=1:length(xc);
    ...
    for a=1:tic-1
        ...
        if C(a,i)==c2
            if g==1
                cw=ft(g,1)/w_mult; w=(ft(g,1)-cw)/4;  d=ft(g,1)-thickness(a,i);
                if d>3*w+cw
                ...
                if d>2*w+cw
                    thickness2(g+1,i)= w;
                    C2(g+1,i)=c2;
                    thickness2(g,i)= thickness(a,i)-w;
                    C2(g,i)=c3;
                    continue
                end
                if d>2*w
                    ...
                    thickness2(g+1,i)= w;
                    C2(g+1,i)=c3;
                    thickness2(g,i)= thickness(a,i)-2*w;
                    C2(g,i)=c4;
                    continue
                end
                if d>=w
                    ...
                    thickness2(g+1,i)= cw;
                    C2(g+1,i)=c4;
                    thickness2(g,i)= thickness(a,i)-(2*w+cw);
                    C2(g,i)=c3;
                    continue
                end
                if d<w
                    ...
                    thickness2(g+1,i)= w;
                    C2(g+1,i)=c3;
                    thickness2(g,i)= thickness(a,i)-(3*w+cw);
                    C2(g,i)=c2;
                    continue
                end
            else
                cw=ft(h,1)/w_mult; w=(ft(h,1)-cw)/4;
                thickness2(g+4,i)= w;
                C2(g+4,i)=c2;
                thickness2(g+3,i)= w;
                C2(g+3,i)=c3;
